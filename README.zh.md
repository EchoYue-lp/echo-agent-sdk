...
当前仓库是从 `echo-agent` 提取的 SDK 源码连续性检查点，已经包含 SDK-owned 历史和
`c5f7688` 冻结 framework 源码。独立构建和兼容性收敛仍由下一迁移结果完成。精确源
revision、历史、迁移路径、已知缺口和 ownership 决策见
[MIGRATION-SOURCE.md](MIGRATION-SOURCE.md) 与
