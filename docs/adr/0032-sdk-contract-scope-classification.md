...
- Status: Accepted
- Date: 2026-09-13
- Owners: `echo-agent-sdk` contract maintainers
...
[ADR 0001](./0001-sdk-repository-boundary.md). The accepted contract scope and
full-inventory telemetry are maintained only in `echo-agent-sdk`; the
framework's public Rust API remains upstream input rather than a second SDK
contract store.
