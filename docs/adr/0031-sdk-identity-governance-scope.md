...
[ADR 0001](./0001-sdk-repository-boundary.md). This inventory and its drift
telemetry are maintained only in `echo-agent-sdk`; the Rust facade it observes
remains owned by `echo-agent`.
