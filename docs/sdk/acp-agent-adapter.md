...
```toml
[dependencies]
echo-agent = { version = "0.2.0", git = "https://github.com/EchoYue-lp/echo-agent.git", rev = "27c7701e1eb116db1076da7f84bb68898544a44c", default-features = false, features = ["acp"] }
